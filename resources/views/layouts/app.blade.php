...
<body class="bg-secondary italic ">
    ...
    <footer class="p-3 text-light d-flex justify-content-between bg-dark row">
        <p class="col-lg-6 col-sm-12 text-lg-start text-center align-items-center">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus saepe, illum <br> Creado por Guillermo Llosa</p>
